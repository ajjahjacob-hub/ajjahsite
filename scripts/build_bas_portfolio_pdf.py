...
def build_pdf() -> Path:
    ...
    works = [
        dict(
            ...
            metadata="SIT 2026  |  ACADEMIC TEAM PROJECT  |  RESULT: 99%",
            ...
            role="Anna Maria contributed to the lead-house design and coordinated the four housing proposals into the final co-housing development.",
            ...
            captions=["Team-developed co-housing overview", "Team presentation: lead-house arrival", "Coordinated team site visualisation"],
        ),
        dict(
            number="02",
